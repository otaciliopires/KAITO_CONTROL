...
class Servico_Oficina(models.Model):
    ...
    data_inicio = models.DateTimeField()
    data_fim = models.DateTimeField(null=True)
    executante_terceiro = models.ForeignKey(Servico_Terceirizado, null=True, on_delete=models.DO_NOTHING)
    executante_funcionario = models.ForeignKey(Funcionario, null=True, on_delete=models.DO_NOTHING)
